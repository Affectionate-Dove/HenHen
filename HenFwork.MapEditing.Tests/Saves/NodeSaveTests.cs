...
namespace HenFwork.MapEditing.Tests.Saves
{
    ...
    {
        private const string test_data = "HenFwork.MapEditing.Tests|Saves.TestNodeForSaving\ttestStringField:hy\tTestStringProperty:da";
        ...
        {
            Assert.AreEqual("HenFwork.MapEditing.Tests", nodeSave.AssemblyName);
            Assert.AreEqual("Saves.TestNodeForSaving", nodeSave.TypeName);
            Assert.AreEqual("HenFwork.MapEditing.Tests.Saves.TestNodeForSaving", nodeSave.FullTypeName);
