...
namespace HenHen.Core.Worlds
{
    public struct DateTime
    {
        ...
        public int Years { get => Get(Months, months_in_year); set => Months = Set(value, months_in_year); }
        public int Months { get => Get(Weeks, weeks_in_month); set => Weeks = Set(value, weeks_in_month); }
        public int Month => Months % months_in_year;
        public int Seasons => (Months + 1) / 2;
        public int Season => Seasons % 4;
        public int Weeks { get => Get(Days, days_in_week); set => Days = Set(value, days_in_week); }
        public int Week => Weeks % weeks_in_month;
        public int Days { get => Get(Hours, hours_in_day); set => Hours = Set(value, hours_in_day); }
        ...
        public int Hours { get => Get(Minutes, minutes_in_hour); set => Minutes = Set(value, minutes_in_hour); }
        public int Hour => Hours % hours_in_day;
        public int Minutes { get => Get(Seconds, seconds_in_minute); set => Seconds = Set(value, seconds_in_minute); }
